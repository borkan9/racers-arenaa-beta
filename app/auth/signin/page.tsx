...
//
// Public sign-in page.
// Supports Google and Discord OAuth via Supabase Auth.
// Redirects authenticated users away (middleware handles this too).
// Never touches app/page.tsx or any existing UI.
...
export default function SignInPage() {
  ...
  const isLoading = (p: Provider) =>
    state.status === "loading" && state.provider === p;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            By signing in you agree to race responsibly.
            <br />
            All runs are subject to anti-cheat review.
          </p>
        </div>
  ...
  return (
    <button
      ...
      style={{
        ...
        gap:            12,
        padding:        "14px 20px",
        background:     hovered && !disabled ? C.surface : C.bg,
        border:         `1px solid ${hovered && !disabled ? C.accent : C.border}`,
        borderRadius:   10,
...
// ─────────────────────────────────────────────────────────────────────────────
// PROVIDER ICONS (inline SVG — zero extra dependencies)
// ─────────────────────────────────────────────────────────────────────────────
